...
if( isset( $_POST[ 'feature_event' ] ) ) {
  ...
  $fields = "location,ticket_uri,facebook_event_id,image_url,start_time,end_time,event_starts,event_ends,fb_event_uri,venue_phone,venue_email,venue_website,facebook,venue_name,venue_desc";
